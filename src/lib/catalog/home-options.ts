...
export const ANILIST_HOME_ROWS: CatalogHomeRowOption[] = [
  ...
  { id: 'recommendations', title: 'Recommended for You', description: 'Suggestions ranked on-device from your watch history and installed catalogs, no account needed.', group: 'Your anime', defaultEnabled: true },
