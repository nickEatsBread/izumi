...
export const SETTINGS_SEARCH_INDEX: SettingSearchItem[] = [
  ...
  { title: 'Rating style', category: 'Interface', href: '/app/settings/interface', keywords: 'score vote rate my rating stars bar numbers 1-10 dropdown menu descriptor appearance', anchored: true },
  { title: 'Show rating on the series page', category: 'Interface', href: '/app/settings/interface', keywords: 'score vote your rating hide hidden always once rated series page', anchored: true },
  { title: 'Ask for a rating when a series ends', category: 'Player', href: '/app/settings/player', keywords: 'score vote rate finale finished prompt end of series', anchored: true },
