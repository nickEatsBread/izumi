...
<div class="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center">
  <input
    ...
    class="h-12 w-full rounded-xl bg-secondary px-4 text-base outline-none focus:outline-none focus-visible:outline-none sm:h-auto sm:min-w-[220px] sm:flex-1 sm:rounded-md sm:px-3 sm:py-2 sm:text-sm"
  />
