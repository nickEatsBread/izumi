...
/// Anime-oriented public trackers used by Shiru in addition to a torrent's own announce list.
...
/// add-ons frequently provide only an info hash; Shiru compensates with application-level
